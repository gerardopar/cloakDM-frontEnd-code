...
const FriendItem = (props) => (
    <div className="friends__user--item z-depth-5">
        ...
        <img className="friends__user--img" src={props.profileImg !== 'https://www.tenforums.com/geek/gars/images/2/types/thumb__ser.png' ? 'http://localhost:3000/' + props.profileImg : 'https://www.tenforums.com/geek/gars/images/2/types/thumb__ser.png'}/>
        </Link>
